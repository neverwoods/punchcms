...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 06, 2013 at 04:01 AM
...
CREATE TABLE IF NOT EXISTS `pcms_alias` (
...
CREATE TABLE IF NOT EXISTS `pcms_announce_message` (
...
CREATE TABLE IF NOT EXISTS `pcms_announce_user` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pcms_audit_log` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `accountId` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `pcms_element` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pcms_element_feed` (
  ...
  `aliasField` varchar(250) NOT NULL,
  `sort` int(11) NOT NULL DEFAULT '0',
  `created` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `pcms_element_field` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `elementId` bigint(20) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `pcms_element_field_bigtext` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pcms_element_field_date` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pcms_element_field_number` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pcms_element_field_text` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pcms_element_language` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `elementId` bigint(20) NOT NULL,
  `languageId` int(11) NOT NULL,
  `cascade` tinyint(4) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `pcms_element_meta`
--

CREATE TABLE IF NOT EXISTS `pcms_element_meta` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `elementId` bigint(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `pcms_element_permission` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `elementId` bigint(20) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `pcms_element_schedule` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `elementId` bigint(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `pcms_element_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `sort` int(11) NOT NULL DEFAULT '0',
  `created` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
(1, 'folder', 0, '2006-06-22 22:19:53', '2006-06-23 02:19:53'),
(2, 'element', 0, '2006-06-22 22:19:53', '2006-06-23 02:19:53'),
(3, 'element container', 0, '2006-06-22 22:19:53', '2006-06-23 02:19:53'),
(4, 'dynamic', 0, '2010-07-05 21:55:40', '2010-07-06 01:55:40'),
(5, 'locked', 0, '2010-07-07 22:16:51', '2010-07-08 02:16:51');
...
CREATE TABLE IF NOT EXISTS `pcms_form` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `accountId` int(11) NOT NULL DEFAULT '0',
  `name` varchar(255) NOT NULL DEFAULT '',
  `apiName` varchar(255) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `pcms_language` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `accountId` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `pcms_search_index` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `elementId` bigint(20) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `pcms_setting` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `accountId` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `pcms_setting_tpl` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(1, 'ftp_server', 'localhost', 'ftp', 'text', 1, '2006-06-23 12:22:08', '2006-06-23 16:22:08'),
(2, 'ftp_username', '', 'ftp', 'text', 2, '2006-06-23 12:22:08', '2006-06-23 16:22:08'),
(3, 'ftp_password', '', 'ftp', 'password', 3, '2006-06-23 12:22:08', '2006-06-23 16:22:08'),
(4, 'ftp_remote_folder', 'httpdocs/files/', 'ftp', 'text', 4, '2006-06-23 12:22:08', '2006-06-23 16:22:08'),
(5, 'file_upload_extensions', '.doc .xls .pdf .zip .exe', 'files', 'text', 100, '2006-06-23 12:22:08', '2006-06-23 16:22:08'),
(6, 'image_upload_extensions', '.jpg .gif .png', 'files', 'text', 101, '2007-03-05 23:13:26', '2007-03-06 03:13:26'),
(7, 'caching_enable', '0', 'caching', 'checkbox', 200, '2007-11-09 17:14:11', '2007-11-09 21:14:11'),
(8, 'caching_timeout', '1440', 'caching', 'text', 203, '2007-11-09 17:14:11', '2007-11-09 21:14:11'),
(10, 'caching_folder', '../cache/', 'caching', 'text', 201, '2007-11-09 17:58:10', '2007-11-09 21:58:10'),
(11, 'file_folder', '/files/', 'files', 'text', 102, '2007-11-09 18:05:01', '2007-11-09 22:05:01'),
(12, 'audit_enable', '0', 'audit', 'checkbox', 400, '2007-11-14 17:53:35', '2007-11-14 21:53:35'),
(13, 'audit_rotation', '7', 'audit', 'number', 401, '2007-11-14 18:00:53', '2007-11-14 22:00:53'),
(14, 'file_download', '/download.php?eid=', 'files', 'text', 203, '2007-11-16 11:20:06', '2007-11-16 15:20:06'),
(15, 'caching_ftp_folder', 'cache', 'caching', 'text', 202, '2007-11-28 16:33:51', '2007-11-28 20:33:51'),
(16, 'elmnt_active_state', '0', 'elements', 'checkbox', 51, '2008-06-09 08:55:08', '2008-06-09 12:55:08'),
(17, 'web_server', '', 'files', 'text', 99, '2009-04-13 21:43:00', '2009-04-14 01:43:00');
...
CREATE TABLE IF NOT EXISTS `pcms_storage_data` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `pcms_storage_item` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `accountId` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `pcms_storage_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(128) NOT NULL,
  `sort` int(11) NOT NULL DEFAULT '0',
  `created` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
(1, 'folder', 0, '2008-09-17 13:42:16', '2008-09-17 17:42:16'),
(2, 'file', 0, '2008-09-17 13:42:16', '2008-09-17 17:42:16');
...
CREATE TABLE IF NOT EXISTS `pcms_structure` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(1, 'complete_layout_nl', 'template', 1, '2007-11-16 15:13:25', '2007-11-16 19:13:25'),
(2, 'contactform_nl', 'template', 3, '2007-11-28 10:56:36', '2007-11-28 14:56:36'),
(3, 'complete_layout_en', 'template', 2, '2008-01-08 11:24:03', '2008-01-08 15:24:03'),
(4, 'validform_nl', 'template', 4, '2009-04-13 21:46:01', '2009-04-14 01:46:01'),
(5, 'validform_en', 'template', 5, '2010-12-30 11:35:53', '2010-12-30 15:35:53');
...
CREATE TABLE IF NOT EXISTS `pcms_structure_meta` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(1, 1, 'english', 'Complete website Dutch', 'Structure for a complete website, with Dutch template and element names. Including Dutch and English languages.', 0, '2007-11-16 15:26:29', '2007-11-16 19:26:29'),
(2, 1, 'nederlands', 'Complete website Nederlands', 'Structuur voor een complete website met Nederlandse sjablonen en elementen, in de talen Engels en Nederlands.', 0, '2007-11-16 15:26:29', '2007-11-16 19:26:29'),
(3, 2, 'english', 'Contact form Dutch', 'Structure for a standard contact form, with Dutch template and element names. Including Dutch and English languages.', 0, '2007-11-28 10:59:57', '2007-11-28 14:59:57'),
(4, 2, 'nederlands', 'Contactformulier Nederlands', 'Structuur voor een standaard contactformulier met Nederlandse sjablonen en elementen, in de talen Engels en Nederlands.', 0, '2007-11-28 10:59:57', '2007-11-28 14:59:57'),
(5, 3, 'english', 'Complete website English', 'Structure for a complete website, with English template and element names. Including Dutch and English languages.', 0, '2008-01-08 11:30:58', '2008-01-08 15:30:58'),
(6, 3, 'nederlands', 'Complete website Engels', 'Structuur voor een complete website met Engelse sjablonen en elementen, in de talen Engels en Nederlands.', 0, '2008-01-08 11:31:33', '2008-01-08 15:31:33'),
(7, 4, 'nederlands', 'ValidForm sjabloon Nederlands', 'Sjabloon voor ValidForm elementen met Nederlandse benamingen', 0, '2009-04-13 21:46:45', '2009-04-14 01:46:45'),
(8, 4, 'english', 'ValidForm template Dutch', 'Template for ValidForm elements with Dutch labels', 0, '2010-12-30 11:37:31', '2010-12-30 15:37:31'),
(9, 5, 'nederlands', 'ValidForm sjabloon Engels', 'Sjabloon voor ValidForm elementen met Engelse benamingen', 0, '2010-12-30 11:41:19', '2010-12-30 15:41:19'),
(10, 5, 'english', 'ValidForm template English', 'Template for ValidForm elements with English labels', 0, '2010-12-30 12:11:14', '2010-12-30 16:11:14');
...
CREATE TABLE IF NOT EXISTS `pcms_template` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `accountId` int(11) NOT NULL DEFAULT '0',
  `name` varchar(255) NOT NULL DEFAULT '',
  `apiName` varchar(255) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `pcms_template_field` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `templateId` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `pcms_template_field_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
(1, 'Date', 'date', 'date', 4, '2006-06-22 22:24:30', '2006-06-23 02:24:30'),
(2, 'Small text', 'text', 'text', 1, '2006-06-22 22:24:30', '2006-06-23 02:24:30'),
(3, 'Large text', 'textarea', 'bigtext', 2, '2006-06-22 22:24:30', '2006-06-23 02:24:30'),
(4, 'File', 'file', 'bigtext', 6, '2006-06-22 22:24:30', '2006-06-23 02:24:30'),
(5, 'Number', 'number', 'number', 3, '2006-06-22 22:24:30', '2006-06-23 02:24:30'),
(6, 'Select list (multi)', 'select', 'bigtext', 7, '2006-06-22 22:24:30', '2006-06-23 02:24:30'),
(7, 'Image', 'file', 'bigtext', 5, '2006-06-22 22:24:30', '2006-06-23 02:24:30'),
(8, 'User', 'select', 'text', 12, '2006-06-22 22:24:30', '2006-06-23 02:24:30'),
(9, 'Deep link', 'link', 'text', 13, '2006-06-22 22:24:30', '2006-06-23 02:24:30'),
(10, 'Boolean', 'checkbox', 'text', 14, '2006-10-24 09:21:01', '2006-10-24 13:21:01'),
(11, 'Select list (single)', 'select', 'bigtext', 8, '2007-05-14 13:46:40', '2007-05-14 17:46:40'),
(12, 'Check list (multi)', 'checkbox', 'bigtext', 9, '2007-05-14 13:50:03', '2007-05-14 17:50:03'),
(13, 'Check list (single)', 'radio', 'bigtext', 10, '2007-05-14 13:50:03', '2007-05-14 17:50:03'),
(14, 'Simple text', 'textarea', 'bigtext', 11, '2008-05-26 10:04:45', '2008-05-26 14:04:45'),
(15, 'MovableCanvas Coordinates', 'text', 'bigtext', 15, '2011-05-26 10:04:45', '2011-05-26 14:04:45');
...
CREATE TABLE IF NOT EXISTS `pcms_template_field_value` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `fieldId` bigint(20) NOT NULL DEFAULT '0',
  `name` varchar(255) NOT NULL DEFAULT '',
  `value` text NOT NULL,
...
CREATE TABLE IF NOT EXISTS `punch_account` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `punch_account` (`id`, `punchId`, `name`, `uri`, `timeZoneId`, `active`, `sort`, `created`, `modified`) VALUES
(1, 'f2vDk4IsgEaH3dcHrkpyerlAuLW4SipZi2uNnPUOnR5MLAzoCz6yAr4MUpqZIhvH', 'Site 1', 'site1', 42, 0, 0, '2013-07-05 14:56:25', '2013-07-05 18:56:25');
...
CREATE TABLE IF NOT EXISTS `punch_account_product` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `accountId` int(11) NOT NULL,
...
INSERT INTO `punch_account_product` (`id`, `accountId`, `productId`, `expires`, `sort`, `created`, `modified`) VALUES
(1, 1, 1, '0000-00-00 00:00:00', 0, '2013-07-05 14:56:25', '2013-07-05 18:56:25');
...
CREATE TABLE IF NOT EXISTS `punch_liveuser_applications` (
...
CREATE TABLE IF NOT EXISTS `punch_liveuser_applications_seq` (
...
CREATE TABLE IF NOT EXISTS `punch_liveuser_areas` (
...
CREATE TABLE IF NOT EXISTS `punch_liveuser_areas_seq` (
  `sequence` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`sequence`)
...
CREATE TABLE IF NOT EXISTS `punch_liveuser_area_admin_areas` (
  `area_id` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `punch_liveuser_grouprights` (
...
CREATE TABLE IF NOT EXISTS `punch_liveuser_groups` (
  `group_id` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `punch_liveuser_groups_seq` (
  `sequence` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`sequence`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `punch_liveuser_groupusers` (
  `perm_user_id` int(11) DEFAULT '0',
  `group_id` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `punch_liveuser_group_subgroups` (
  `group_id` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `punch_liveuser_perm_users` (
  `perm_user_id` int(11) DEFAULT '0',
...
INSERT INTO `punch_liveuser_perm_users` (`perm_user_id`, `auth_user_id`, `auth_container_name`, `perm_type`) VALUES
(1, '1', 'MDB2', 5),
(2, '2', 'MDB2', 4);
...
CREATE TABLE IF NOT EXISTS `punch_liveuser_perm_users_seq` (
  `sequence` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`sequence`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;
...
INSERT INTO `punch_liveuser_perm_users_seq` (`sequence`) VALUES
(2);
...
CREATE TABLE IF NOT EXISTS `punch_liveuser_rights` (
  `right_id` int(11) DEFAULT '0',
  `area_id` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `punch_liveuser_rights_seq` (
  `sequence` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`sequence`)
...
CREATE TABLE IF NOT EXISTS `punch_liveuser_right_implied` (
  `right_id` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `punch_liveuser_translations` (
...
CREATE TABLE IF NOT EXISTS `punch_liveuser_translations_seq` (
  `sequence` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`sequence`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `punch_liveuser_userrights` (
  `perm_user_id` int(11) DEFAULT '0',
  `right_id` int(11) DEFAULT '0',
  `right_level` int(11) DEFAULT NULL,
  `account_id` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `punch_liveuser_users` (
...
INSERT INTO `punch_liveuser_users` (`authuserid`, `handle`, `passwd`, `name`, `email`, `time_zone_id`, `owner_user_id`, `owner_group_id`, `account_id`, `lastlogin`, `isactive`) VALUES
('1', 'admin', '3ee4f26dd549dfebd8404573738d23523edfba7d', 'PunchCMS Super Admin', 'alex@spin.an', 1, NULL, NULL, 0, '2013-07-05 14:01:05', 1),
('2', 'admin', '3ee4f26dd549dfebd8404573738d23523edfba7d', 'admin', NULL, 1, NULL, NULL, 1, NULL, 1);
...
CREATE TABLE IF NOT EXISTS `punch_liveuser_users_seq` (
  `sequence` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`sequence`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;
...
INSERT INTO `punch_liveuser_users_seq` (`sequence`) VALUES
(2);
...
CREATE TABLE IF NOT EXISTS `punch_product` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `parentId` int(11) NOT NULL DEFAULT '0',
  `name` varchar(150) NOT NULL,
  `active` tinyint(4) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `punch_timezone` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
ALTER TABLE `pcms_element_language`
  ADD CONSTRAINT `pcms_element_language_ibfk_2` FOREIGN KEY (`languageId`) REFERENCES `pcms_language` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `pcms_element_language_ibfk_1` FOREIGN KEY (`elementId`) REFERENCES `pcms_element` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `pcms_element_meta`
--
ALTER TABLE `pcms_element_meta`
  ADD CONSTRAINT `pcms_element_meta_ibfk_2` FOREIGN KEY (`elementId`) REFERENCES `pcms_element` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `pcms_element_meta_ibfk_1` FOREIGN KEY (`languageId`) REFERENCES `pcms_language` (`id`) ON DELETE CASCADE;
