...
$_LANG['button']['newField'] = "Field";
$_LANG['button']['newFolder'] = "Folder";
$_LANG['button']['newFile'] = "File";
$_LANG['button']['newForm'] = "Form";
$_LANG['button']['newDynamic'] = "Dynamic";
$_LANG['button']['newStructure'] = "Structure";
...
$_LANG['button']['languageAdd'] = "Language";
$_LANG['button']['aliasAdd'] = "Alias";
...
$_LANG['form']['basepath'] = "Base path";
$_LANG['form']['maxItems'] = "Maximum generated items";
$_LANG['form']['sortBy'] = "Sort by";
...
$_LANG['tip']['basepath'] = "Enter the base path of the first item you want to use.";
