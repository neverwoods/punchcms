...
//*** Button definitions.
$_LANG['button']['newElement'] = "Nieuw Element";
$_LANG['button']['newTemplate'] = "Nieuw Sjabloon";
$_LANG['button']['newField'] = "Nieuw Veld";
$_LANG['button']['newFolder'] = "Nieuwe Map";
$_LANG['button']['newFile'] = "Nieuw Bestand";
$_LANG['button']['newForm'] = "Nieuw Formulier";
$_LANG['button']['newStructure'] = "Nieuwe Structuur";
...
$_LANG['label']['default'] = "standaardwaarde";
$_LANG['label']['imagesCurrent'] = "Reeds geuploade plaatjes";
$_LANG['label']['imagesNew'] = "Nieuwe plaatjes";
...
$_LANG['typeLabel']['maxImages'] = "Maximaal aantal plaatjes";
...
$_LANG['form']['container'] = "Kan ook bovenliggende sjablonen bevatten";
$_LANG['form']['forceCreation'] = "Wordt automatisch aangemaakt";
...
$_LANG['form']['publishInfo'] = "Het is mogelijk om de exacte publicatie tijd voor dit element op te geven.";
$_LANG['form']['permissionInfo'] = "Pas specifieke rechten voor dit element aan.";
$_LANG['form']['editAlias'] = "Pas deze snelkoppeling aan";
$_LANG['form']['addAlias'] = "Voeg een snelkoppeling toe";
...
$_LANG['alert']['multiItemEmpty'] = "U heeft geen item(s) geselcteerd waar u deze actie op uit kunt voeren."; 
