...
//*** Added by PtC
 dhtmlXTreeObject.prototype.onImageSelect=function(e,htmlObject,mode){
 e=e||window.event;
 ...
 if(!mode){
 if((e)&&(e.button==2)&&(that.arFunc))that.arFunc(obj.id);
 if(that.imgFunc)that.imgFunc(obj.id);
 }
};

 dhtmlXTreeObject.prototype.onImageRollOver=function(e,htmlObject,mode){
 var obj=this.parentObject;
 if(htmlObject)obj=htmlObject.parentObject;
 var that=obj.treeNod;
 if(that.imgRollOverFunc)that.imgRollOverFunc(obj.id);
};

 dhtmlXTreeObject.prototype.onImageRollOut=function(e,htmlObject,mode){
 var obj=this.parentObject;
 if(htmlObject)obj=htmlObject.parentObject;
 var that=obj.treeNod;
 if(that.imgRollOutFunc)that.imgRollOutFunc(obj.id);
};

 dhtmlXTreeObject.prototype.setOnImageClickHandler=function(func){if(typeof(func)=="function")this.imgFunc=func;else this.imgFunc=eval(func);};
 dhtmlXTreeObject.prototype.setOnImageRollOverHandler=function(func){if(typeof(func)=="function")this.imgRollOverFunc=func;else this.imgRollOverFunc=eval(func);};
 dhtmlXTreeObject.prototype.setOnImageRollOutHandler=function(func){if(typeof(func)=="function")this.imgRollOutFunc=func;else this.imgRollOutFunc=eval(func);};
//***
 ...
 else
{
 ...
 //*** Added by PtC
 img.onclick=this.onImageSelect;
 img.onmouseover=this.onImageRollOver;
 img.onmouseout=this.onImageRollOut;
 //***
...
dhtmlXTreeObject.prototype._distributedStep=function(pId){
 ...
 if((!this._edsbpsA)||(!this._edsbpsA.length))return;
