...
FCKConfig.SkinPath = FCKConfig.BasePath + 'skins/mijnpunch/' ;
...
FCKConfig.ToolbarSets["Default"] = [
	...
	['Bold','Italic','-','Subscript','Superscript','-','OrderedList','UnorderedList','-',
	'JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','TextColor','FontSize']
] ;
