...
--
-- Host: localhost
-- Generation Time: Apr 26, 2011 at 12:22 AM
...
CREATE TABLE `pcms_element_feed` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `pcms_element_field_feed` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
(4, 'dynamic', 0, '2010-07-05 21:55:40', '2010-07-05 21:55:40'),
(5, 'locked', 0, '2010-07-07 22:16:51', '2010-07-07 22:16:51');
...
(4, 'validform_nl', 'template', 4, '2009-04-13 21:46:01', '2009-04-13 21:46:01'),
(5, 'validform_en', 'template', 5, '2010-12-30 11:35:53', '2010-12-30 11:35:53');
...
(7, 4, 'nederlands', 'ValidForm sjabloon Nederlands', 'Sjabloon voor ValidForm elementen met Nederlandse benamingen', 0, '2009-04-13 21:46:45', '2009-04-13 21:46:45'),
(8, 4, 'english', 'ValidForm template Dutch', 'Template for ValidForm elements with Dutch labels', 0, '2010-12-30 11:37:31', '2010-12-30 11:37:31'),
(9, 5, 'nederlands', 'ValidForm sjabloon Engels', 'Sjabloon voor ValidForm elementen met Engelse benamingen', 0, '2010-12-30 11:41:19', '2010-12-30 11:41:19'),
(10, 5, 'english', 'ValidForm template English', 'Template for ValidForm elements with English labels', 0, '2010-12-30 12:11:14', '2010-12-30 12:11:14');
...
(15, 'MovableCanvas Coordinates', 'text', 'bigtext', 15, '2011-07-18 22:45:34', '2011-07-18 22:45:34');
