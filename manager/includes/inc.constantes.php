...
define('CMD_EXPORT_TEMPLATE', 22);
define('CMD_IMPORT_TEMPLATE', 23);
define('CMD_EXPORT_ELEMENT', 24);
define('CMD_IMPORT_ELEMENT', 25);
...
define('FIELD_TYPE_MOVABLECANVAS_COORDINATES', 15);
